...
<title>Evaluación El Bosque y Áreas Protegidas · Forma ${forma}</title>
<style>
...
.sec-title{font-size:10.5pt;font-weight:700;padding:0.22rem 0.5rem;margin:0.4rem 0 0.2rem;border-left:4px solid #2d7a4f;background:#e8f5e9;display:flex;justify-content:space-between;align-items:center;}
...
.pr-item{font-size:10pt;padding:0.22rem 0.32rem;background:#e8f5e9;border-radius:3px;margin-bottom:0.12rem;display:flex;align-items:center;gap:0.22rem;line-height:1.2;break-inside:avoid;}
.pr-num{font-weight:700;color:#2d7a4f;min-width:19px;flex-shrink:0;}
...
.obt-row{display:flex;align-items:baseline;gap:4px;font-size:9pt;color:#2d7a4f;font-weight:700;font-style:italic;}
.obt-lbl{font-weight:700;}.obt-line{display:inline-block;min-width:58px;border-bottom:1.5px solid #2d7a4f;height:12px;}.obt-pct{font-weight:700;}
.total-row{display:flex;align-items:baseline;justify-content:flex-start;margin-left:20%;gap:7px;font-size:11pt;color:#2d7a4f;font-weight:700;font-style:italic;margin-top:0.3rem;padding:0.2rem 0;}
.total-row .obt-line{min-width:80px;border-bottom:1.5px solid #2d7a4f;}
...
<div class="ph">
  <h2>Evaluación Final · El Bosque y las Áreas Protegidas de Honduras · II y III Ciclo · Ciencias Naturales</h2>
...
<div class="pauta-wrap">
  <div class="p-head">
    <div class="p-main">✅ PAUTA · El Bosque y Áreas Protegidas · Forma ${forma}</div>
