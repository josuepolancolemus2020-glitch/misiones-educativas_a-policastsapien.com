...
> hoja de estilo, ni un `preconnect`, ni un `@import` sale del sitio, en las 184 páginas.
>
...
>
> Lo comprueba **`_dev/verifica-cdn-fuera.js`**, que lee las 184 páginas y las 82 hojas de estilo
> del archivo —abrirlas con Playwright no lo corre nadie— y abre tres con los tres servidores
