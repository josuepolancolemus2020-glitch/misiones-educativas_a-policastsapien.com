...
- **Código auditado:** `main` en `d940fe0` (9 de septiembre de 2026), con las 20 modificaciones de `_dev/auditoria-2026-09/5-top-20.md` ya aplicadas. Todo se juzgó contra ese código, no contra el de agosto; donde un hallazgo ya estaba escrito en la primera corrida (U13-05, U13-10) se dice y se vuelve a medir.
