...
const CORPUS = [
  ...
  { archivo: 'misiones/2y3ciclo-acentuacion/js/lectura-acentuacion.js', constante: 'LECTURA_ACENTUACION',
    mision: 'La Acentuación', prefijo: 'LT', inventario: 'acentos',
    listas: [['porRegla', 'palabra tildada por la regla', true], ['diacritica', 'tilde diacrítica', true],
             ['neutros', 'palabra que no cuenta', false]],
    cerrada: null, segunda: 'diacritica', minSegunda: 3 },
  ...
  { archivo: 'misiones/2y3ciclo-adverbios/js/lectura-adverbios.js', constante: 'LECTURA_ADVERBIOS',
    ...
    listas: [['lugarTiempo', 'adverbio de lugar o tiempo', true], ['modoCantidad', 'adverbio de modo o cantidad', true],
             ['neutros', 'palabra que no cuenta', false]],
    cerrada: null, segunda: 'modoCantidad', minSegunda: 3 },
