...
const MISSIONS = [
  ...
  { id:  6, title: 'Números Grandes: del Cien al Millón',       subject: 'matemáticas', color: 'mat',  grade: 'I y II Ciclo',   cycle: '1ciclo',   ruta: 'numero',  etapa: 0, xp: 30, icon: '🔢', pais: 'HN', url: 'misiones/1ciclo-2º-grado/numeros-hasta-999.html' },
  ...
  { id:  9, title: 'Las Eras Geológicas',                       subject: 'naturales',   color: 'cnat', grade: 'II y III Ciclo', cycle: '2y3ciclo', ruta: 'planeta', etapa: 5, xp: 35, icon: '🦕', pais: 'HN', url: 'misiones/2y3ciclo-eras-geológicas/eras_geológicas.html' },
  { id: 10, title: 'Áreas Protegidas de Honduras',              subject: 'naturales',   color: 'cnat', grade: 'II y III Ciclo', cycle: '2y3ciclo', ruta: 'planeta', etapa: 6, xp: 30, icon: '🌿', pais: 'HN', url: 'misiones/2y3ciclo-áreas-protegidas-de-honduras/2y3ciclo-áreas-protegidas-de-Honduras.html' },
  ...
  { id: 11, title: 'Geografía y Coordenadas',                   subject: 'sociales',    color: 'csoc', grade: 'II y III Ciclo', cycle: '2y3ciclo', ruta: 'planeta', etapa: 1, xp: 25, icon: '🗺️', pais: 'HN', url: 'misiones/2y3ciclo-geografía-coordenadas/2y3ciclo_geografia-coordenadas.html' },
  ...
  { id: 13, title: 'Continentes: América, Oceanía y Antártida', subject: 'sociales',    color: 'csoc', grade: 'II y III Ciclo', cycle: '2y3ciclo', ruta: 'planeta', etapa: 2, xp: 30, icon: '🌎', pais: 'HN', url: 'misiones/2y3ciclo-los-continentes-América-Oceanía-Antártida/2y3ciclo-los-continentes-América-Oceanía-Antártida.html' },
