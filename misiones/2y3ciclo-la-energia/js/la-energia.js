...
const evalMCBank=[
  {q:'¿Qué es la energía?',o:['a) Un tipo de materia','b) Un color','c) La capacidad de producir cambios o realizar un trabajo','d) Un ser vivo'],a:2},
  {q:'¿Qué forma de energía es la luz?',o:['a) Sonora','b) Luminosa','c) Mecánica','d) Eléctrica'],a:1},
  {q:'¿Qué forma de energía es el calor?',o:['a) Sonora','b) Calorífica','c) Luminosa','d) Mecánica'],a:1},
  {q:'¿Qué forma de energía es el sonido?',o:['a) Sonora','b) Luminosa','c) Mecánica','d) Calorífica'],a:0},
  {q:'¿Qué forma de energía produce movimiento?',o:['a) Sonora','b) Luminosa','c) Calorífica','d) Mecánica'],a:3},
  {q:'¿Cuál es la principal fuente de energía de la Tierra?',o:['a) El viento','b) El Sol','c) El petróleo','d) El carbón'],a:1},
  ...
  {q:'La energía eléctrica de una plancha se transforma en energía…',o:['a) calorífica','b) luminosa','c) sonora','d) mecánica'],a:0},
  {q:'¿Qué le pasa a la energía?',o:['a) Se crea de la nada','b) Se destruye','c) Desaparece','d) Solo se transforma'],a:3},
  {q:'¿Por qué debemos ahorrar energía?',o:['a) Porque muchas fuentes se agotan y contaminan','b) Porque nunca se acaba','c) Porque es gratis','d) Porque no sirve'],a:0},
  {q:'La represa El Cajón produce energía…',o:['a) del petróleo','b) del carbón','c) hidroeléctrica (del agua)','d) del gas'],a:2},
  {q:'¿Qué usan las plantas para fabricar su alimento?',o:['a) El petróleo','b) La energía del Sol','c) El carbón','d) La electricidad'],a:1},
  {q:'¿Cuál es un buen hábito para ahorrar energía?',o:['a) Dejar luces encendidas','b) Abrir el refri seguido','c) Apagar los aparatos que no se usan','d) No aprovechar el día'],a:2},
];
const evalCPBank=[
