...
// ===================== QUIZ DATA =====================
const qzData=[
  {q:'¿Qué es la energía?',o:['a) La capacidad de producir cambios o realizar un trabajo','b) Un tipo de materia','c) Un color','d) Un ser vivo'],c:0},
  {q:'¿Qué forma de energía es la luz?',o:['a) Sonora','b) Luminosa','c) Mecánica','d) Eléctrica'],c:1},
  {q:'¿Qué forma de energía es el calor?',o:['a) Calorífica','b) Sonora','c) Luminosa','d) Mecánica'],c:0},
  {q:'¿Qué forma de energía produce movimiento?',o:['a) Sonora','b) Luminosa','c) Calorífica','d) Mecánica'],c:3},
  {q:'¿Cuál es la principal fuente de energía de la Tierra?',o:['a) El viento','b) El petróleo','c) El carbón','d) El Sol'],c:3},
  ...
  {q:'La energía eléctrica de una bombilla se transforma en energía…',o:['a) sonora','b) mecánica','c) luminosa','d) química'],c:2},
  {q:'¿Por qué debemos ahorrar energía?',o:['a) Porque muchas fuentes se agotan y contaminan','b) Porque nunca se acaba','c) Porque es gratis','d) Porque no sirve'],c:0},
];
...
// ===================== COMPLETA =====================
const cmpData=[
  {s:'La ___ es la capacidad de producir cambios.',opts:['energía','materia','masa'],c:0},
  {s:'La energía de la luz es la ___.',opts:['sonora','mecánica','luminosa'],c:2},
  {s:'La energía del calor es la ___.',opts:['sonora','eléctrica','calorífica'],c:2},
  {s:'La principal fuente de energía de la Tierra es el ___.',opts:['Sol','viento','petróleo'],c:0},
  ...
  {s:'La energía no se crea ni se destruye: solo se ___.',opts:['transforma','pierde','acaba'],c:0},
...
const evalMCBank=[
  {q:'¿Qué es la energía?',o:['a) Un tipo de materia','b) Un color','c) La capacidad de producir cambios o realizar un trabajo','d) Un ser vivo'],a:2,k:'mc-energia'},
...
const evalPRBank=[
  ...
  {term:'Energía calorífica',def:'La de una fogata',k:'pr-calorifica'},
  {term:'Energía sonora',def:'La de la música',k:'pr-sonora'},
  {term:'Energía mecánica',def:'La de un carro que avanza',k:'pr-mecanica'},
  {term:'Energía eléctrica',def:'La que hace funcionar los aparatos',k:'pr-electrica'},
  {term:'Energía química',def:'La que guardan los alimentos y las pilas',k:'pr-quimica'},
  {term:'Energía eólica',def:'La que da el viento',k:'pr-eolica'},
  {term:'Hidroeléctrica',def:'La que se obtiene de la fuerza del agua',k:'pr-hidroelectrica'},
  {term:'Petróleo',def:'De él sale la gasolina',k:'pr-petroleo'},
  {term:'Fotosíntesis',def:'Las plantas fabrican su alimento con la luz del Sol',k:'pr-fotosintesis'}
];
...
const critCaseBank=[
  {k:'ca-molinos',txt:'Un pueblo aprovecha el viento fuerte de la zona para instalar molinos que generan electricidad.'},
  {k:'ca-represa',txt:'Una represa usa la fuerza del agua que cae para producir electricidad para muchas casas.'},
  {k:'ca-sequia',txt:'En un verano muy seco baja el nivel del agua de la represa El Cajón y hay apagones en varias ciudades de Honduras.'},
  {k:'ca-cafe',txt:'Un productor de café seca sus granos extendiéndolos al sol en el patio, en vez de usar una secadora que quema combustible.'},
  {k:'ca-eolico',txt:'En el sur de Honduras, un parque eólico usa el viento fuerte de la zona para generar electricidad para miles de casas.'},
];
...
const critErrorBank=[
  ...
  {k:'er-ventilador',txt:'"Un ventilador transforma la energía eléctrica en energía luminosa."',
...
const critDecisionBank=[
  {k:'de-cortinas',txt:'Para iluminar una casa de día, conviene abrir las cortinas y usar la luz del Sol, o encender todas las lámparas.',
  ...
  {k:'de-apagar',txt:'Al salir de un cuarto, conviene apagar la luz y el ventilador, o dejarlos encendidos.',
  ...
  {k:'de-plancha',txt:'Para gastar menos energía al planchar, conviene juntar la ropa y planchar de una vez, o planchar prenda por prenda.',
  ...
  {k:'de-desconectar',txt:'Para cuidar la energía, conviene desconectar los aparatos que no se usan, o dejarlos siempre conectados.',
  ...
  {k:'de-refri',txt:'Para tomar agua fría, conviene sacar del refrigerador todo lo que necesitas de una sola vez, o abrir la puerta muchas veces al día.',
...
const critCompareBank=[
  {k:'co-panel-pila',a:'Un panel solar recibe energía del Sol todos los días.',b:'La pila de una linterna se gasta hasta quedar sin energía.',
...
const critCauseBank=[
  {k:'cau-clima',cause:'El Sol calienta el aire y el agua del mar.',guide:'Se forman el viento y la lluvia.'},
  {k:'cau-correr',cause:'Una persona come y después sale a correr.',guide:'La energía química de los alimentos se vuelve movimiento.'},
];
const critEffectBank=[
  {k:'ef-plantas',effect:'Las plantas crecen y fabrican su alimento.',guide:'Usan la energía del Sol en la fotosíntesis.'},
  {k:'ef-ropa',effect:'La ropa tendida al aire libre se seca.',guide:'Recibe el calor del Sol, y el aire que corre se lleva la humedad.'},
  {k:'ef-descarga',effect:'Una persona toca un enchufe con las manos mojadas y recibe una descarga.',guide:'La electricidad pasa por el agua y por su cuerpo: es peligrosa.'},
];
