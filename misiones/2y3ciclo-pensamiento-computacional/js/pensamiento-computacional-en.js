  ...
  window.MISION_EN = {
    ...
    html: {
      ...
      rec:
        ...
        '</div>' +
        '<p style="font-size:0.9rem;margin-bottom:0;">This mission does not have an online materials folder yet. What is ready is the <strong>printable study sheet</strong> above: it carries the theory, the activities and the test on paper, to work without a phone and without internet.</p>' +
        '</div>'
    },
    ...
    data: {
      ...
      evalMCBank: [
        ...
        { q: 'A good step starts with…', o: ['A riddle', 'A greeting', 'An action word, such as «wash» or «cut»', 'A joke'], a: 2 },
        { q: 'Which small part belongs to «setting up the school garden»?', o: ['Buying a TV', 'Painting the flag', 'Making a fruit drink', 'Preparing the soil'], a: 3 },
        { q: 'What is computational thinking?', o: ['Using the computer all day', 'Thinking in steps, parts and what repeats before acting', 'Memorizing numbers', 'Writing fast'], a: 1 },
        { q: 'What matters to sell nance drinks at the fair?', o: ['The color of the bowl', 'The time of day', 'The nances, the sugar and the ice', 'The name of the cup'], a: 2 },
        { q: 'What repeats when making tortillas?', o: ['Each tortilla is patted and cooked the same way', 'Nothing, each one is different', 'Only the first one is cooked', 'The dough changes every time'], a: 0 }
      ],
      ...
      evalPRBank: [
        { term: 'Algorithm', def: 'Ordered steps to achieve something' },
        { term: 'Ambiguity', def: '«Make it pretty»' },
        { term: 'Decompose', def: 'What you do to a huge problem before sharing it out' },
        { term: 'Pattern', def: 'What repeats' },
        { term: 'Abstraction', def: 'Keeping only what matters' },
        { term: 'Verb', def: '«Wash», «knead», «fold»' },
        { term: 'Recipe', def: 'A cooking algorithm' },
        { term: 'Committee', def: 'A group in charge of one part of the fair' },
        { term: 'Map', def: 'It does not draw every stone on the road' },
        { term: 'Backpack', def: 'It is packed with steps in order' }
      ],
    ...
    fragmentos: [
      ...
      [/Falta calificar: IV\. Vida real \((\d+) pts\)\. Eso lo escribiste tú y lo revisa tu maestro con la pauta; tu autoevaluación fue (\d+)\/(\d+) y no cuenta para esta nota\./g,
        'Still to be graded: IV. Real life ($1 pts). You wrote that yourself and your teacher checks it against the answer key; your self-assessment was $2/$3 and it does not count towards this score.'],
      [/Ordena: (\d+)\/20 · Exacta o ambigua: (\d+)\/10 · Completa: (\d+)\/20 · Retos: (\d+)\/20/g,
        'Order: $1/20 · Exact or ambiguous: $2/10 · Fill in: $3/20 · Challenges: $4/20'],
