...
const evalMCBank=[
  {q:'Para dibujar un cuadrado, el robot ejecuta REPETIR ___ VECES [AVANZA, GIRA DERECHA]. ¿Qué número falta?',o:['a) 2','b) 3','c) 4','d) 8'],a:2,k:'mc-cuadrado'},
  {q:'¿Cuántas instrucciones EJECUTA en total el robot con REPETIR 3 VECES [AVANZA, GIRA DERECHA]?',o:['a) 2','b) 3','c) 5','d) 6'],a:3,k:'mc-ejecuta'},
  {q:'¿Cuántas instrucciones ESCRIBES con REPETIR 8 VECES [AVANZA]?',o:['a) 8','b) 2','c) 9','d) 1'],a:1,k:'mc-escribes'},
  {q:'¿Qué significa la N en REPETIR N VECES?',o:['a) El número de robots','b) Cuántas veces se hace lo de adentro','c) El número de casillas del mapa','d) El nombre del programa'],a:1,k:'mc-n'},
  {q:'¿Qué tarea de la vida diaria se parece más a REPETIR?',o:['a) Nacer','b) Cortar el listón de inauguración','c) Encender el fogón una vez','d) Dar 20 pasos'],a:3,k:'mc-pasos'},
  {q:'¿Qué pasa si la N está errada?',o:['a) La figura sale mal','b) No pasa nada','c) El robot escribe más','d) El programa se vuelve exacto'],a:0,k:'mc-n-errada'},
  {q:'¿Qué dibuja REPETIR N VECES [AVANZA]?',o:['a) Un cuadrado','b) Una línea recta','c) Una escalera','d) Un círculo'],a:1,k:'mc-linea'},
  {q:'¿Qué programa deja al robot mirando al lado contrario?',o:['a) REPETIR 2 VECES [GIRA DERECHA]','b) REPETIR 4 VECES [GIRA DERECHA]','c) REPETIR 3 VECES [AVANZA]','d) AVANZA'],a:0,k:'mc-media'},
  {q:'¿Cuál es la mejor forma de escribir seis AVANZA seguidos?',o:['a) REPETIR 5 VECES [AVANZA]','b) AVANZA seis veces','c) REPETIR 6 VECES [GIRA DERECHA]','d) REPETIR 6 VECES [AVANZA]'],a:3,k:'mc-seis'},
...
const evalPRBank=[
  {term:'Bucle',def:'Repite instrucciones sin volver a escribirlas',k:'pr-bucle'},
  {term:'Cuerpo del bucle',def:'Lo que va dentro de los corchetes',k:'pr-cuerpo'},
  {term:'Vuelta',def:'Cada repetición completa de lo de adentro',k:'pr-vuelta'},
  {term:'Rastro',def:'Las casillas pintadas por donde pasa el robot',k:'pr-rastro'},
  {term:'Patrón',def:'Algo que se repite siguiendo una regla',k:'pr-patron'},
  {term:'Bucle anidado',def:'Un bucle dentro de otro',k:'pr-anidado'},
  {term:'Expandir',def:'Escribir la lista completa que el bucle ejecuta',k:'pr-expandir'},
  {term:'Compactar',def:'Convertir un programa largo en uno corto',k:'pr-compactar'},
  {term:'Equivalencia',def:'Dos programas que hacen exactamente lo mismo',k:'pr-equivalencia'},
  {term:'Ahorro',def:'Las instrucciones que dejas de escribir',k:'pr-ahorro'}
];
