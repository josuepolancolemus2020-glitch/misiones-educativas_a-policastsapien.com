...
const evalMCBank=[
  ...
  {q:'¿Qué pasa con las quebradas donde se tala el bosque?',o:['a) crecen más en verano','b) se vuelven salados','c) no cambian','d) se secan en verano'],a:3,k:'mc-rios-secan'},
...
const evalCPBank=[
  {q:'El bosque que más espacio ocupa en Honduras es el de pino-___.',a:'roble',acc:['roble'],k:'cp-roble'},
  {q:'El punto más alto de Honduras está en el Parque Nacional ___.',a:'Celaque',acc:['Celaque'],k:'cp-celaque'},
  {q:'Cuando la lluvia lava el suelo que quedó sin árboles, eso es ___.',a:'erosión',acc:['erosión'],k:'cp-erosion'},
  {q:'La reserva más grande del país cubre ___ hectáreas.',a:'832,000',acc:['832,000','832000','832.000'],k:'cp-832000'},
  {q:'Los monos araña, la lapa roja y el ___ viven en la reserva más grande del país.',a:'caimán',acc:['caimán'],k:'cp-caiman'},
  {q:'La plaga del gorgojo ___ ataca los pinos.',a:'descortezador',acc:['descortezador'],k:'cp-descortezador'},
  {q:'En la reserva más grande viven los pueblos Pech, Miskitu, Tawahka y ___.',a:'Garífuna',acc:['Garífuna'],k:'cp-garifuna'},
...
const evalPRBank=[
  ...
  {term:'Río Plátano',def:'La zona protegida más grande del país',k:'pr-rio-platano'},
  {term:'Cerro Las Minas',def:'El punto más alto de Honduras',k:'pr-las-minas'},
  {term:'SINAPH',def:'El sistema que reúne las áreas protegidas',k:'pr-sinaph'},
  {term:'Manglar',def:'Bosque de la costa, criadero de peces y mariscos',k:'pr-manglar'},
  {term:'Quetzal',def:'Ave de los bosques de neblina',k:'pr-quetzal'},
...
.tf-row{display:flex;align-items:baseline;gap:0.3rem;font-size:10.5pt;line-height:1.3;padding:0.13rem 0.2rem;border-bottom:1px solid #eee;}
.tf-blank{display:inline-block;min-width:40px;border-bottom:1.5px solid #111;flex-shrink:0;margin:0 0.18rem;}
.tf-text{flex:1;}
.mc-item {border:1px solid #ddd;border-radius:4px;padding:0.14rem 0.35rem;margin-bottom:0.1rem;break-inside:avoid;page-break-inside:avoid;}
.mc-q{font-size:10.5pt;line-height:1.3;display:flex;gap:0.28rem;margin-bottom:0.07rem;}
.mc-grid{display:grid;grid-template-columns:1fr 1fr;gap:0.1rem 0.5rem;}
.mc-opts{display:grid;grid-template-columns:repeat(4,1fr);gap:0.04rem 0.15rem;margin-left:0.8rem;}
.mc-opt{font-size:9pt;display:flex;align-items:center;gap:0.15rem;}
.mc-opt input{width:10px;height:10px;flex-shrink:0;}
.cp-row{display:flex;align-items:baseline;gap:0.3rem;font-size:10.5pt;line-height:1.3;padding:0.13rem 0.2rem;border-bottom:1px solid #eee;}
.cp-text{flex:1;}
...
<div class="ph">
  <h2>Evaluación Final · Áreas Protegidas de Honduras · Educación Básica · Ciencias Naturales</h2>
