...
const qzData=[
  ...
  {q:'¿Cuál es el perímetro de un cuadrado de lado 6 cm?',o:['a) 36 cm','b) 12 cm','c) 24 cm','d) 18 cm'],c:2,feedback:'P = 4 × 6 = 24 cm. Se suman los 4 lados iguales.'},
  {q:'¿Cuál es el área de un cuadrado de lado 6 cm?',o:['a) 36 cm²','b) 24 cm²','c) 12 cm²','d) 30 cm²'],c:0,feedback:'A = lado × lado = 6 × 6 = 36 cm².'},
  {q:'¿Cuál es el área de un rectángulo de 8 × 3?',o:['a) 22 cm²','b) 11 cm²','c) 16 cm²','d) 24 cm²'],c:3,feedback:'A = base × altura = 8 × 3 = 24 cm².'},
  {q:'¿Cuál es el perímetro de un rectángulo de 8 × 3?',o:['a) 24 cm','b) 11 cm','c) 22 cm','d) 16 cm'],c:2,feedback:'P = 2 × (8 + 3) = 2 × 11 = 22 cm.'},
  {q:'¿En qué unidad se mide el área?',o:['a) en cm²','b) en cm','c) en litros','d) en grados'],c:0,feedback:'El área se mide en unidades cuadradas: cm², m²…'},
  {q:'Para cercar un terreno cuadrado, ¿qué calculo?',o:['a) el área','b) el volumen','c) la altura','d) el perímetro'],c:3,feedback:'La cerca rodea el terreno: es el perímetro.'},
  ...
  {q:'¿Cuál fórmula es la del área del rectángulo?',o:['a) base × altura','b) 4 × lado','c) 2 × (base + altura)','d) lado + lado'],c:0,feedback:'El área del rectángulo es base × altura.'}
];
...
const cmpData=[
  ...
  {s:'El perímetro de un cuadrado es 4 × ___.',opts:['base','lado','altura'],c:1},
  ...
  {s:'Para cercar un terreno se calcula el ___.',opts:['perímetro','área','volumen'],c:0}
];
