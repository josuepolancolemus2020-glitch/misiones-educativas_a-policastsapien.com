...
const sopaSets=[
    ...
    },
    {
        ...
        words: [
            ...
            { w: 'ENORME', cells: [[3, 9], [4, 9], [5, 9], [6, 9], [7, 9], [8, 9]] },
...
const evalTFBank=[
  {q:'En «la casa blanca», «blanca» es un adjetivo calificativo.',a:true,k:'tf-blanca'},
  {q:'«Esos» es un adjetivo posesivo.',a:false,k:'tf-esos'},
  ...
  {q:'En «los niños alegres», el adjetivo debería ser «alegre».',a:false,k:'tf-alegres'}
];
const evalMCBank=[
  {q:'¿Cuál de estas palabras es un adjetivo?',o:['a) cantar','b) montaña','c) verde','d) nosotros'],a:2,k:'mc-es-adjetivo'},
  {q:'«Tu» en «tu cuaderno» es un adjetivo…',o:['a) calificativo','b) posesivo','c) numeral','d) demostrativo'],a:1,k:'mc-tu'},
  {q:'¿Cuál es la forma más intensa de «bueno»?',o:['a) mejor','b) buenísimo','c) muy mejor','d) bonito'],a:1,k:'mc-buenisimo'},
  {q:'«Pequeñísimo» viene del adjetivo…',o:['a) pequeño','b) pequeñito','c) peque','d) pequeñez'],a:0,k:'mc-pequenisimo'},
  {q:'En «Algunas personas llegaron», «algunas» es un adjetivo…',o:['a) posesivo','b) indefinido','c) numeral','d) demostrativo'],a:1,k:'mc-algunas'},
  {q:'¿Qué adjetivo va bien con «las casas»?',o:['a) bonito','b) bonita','c) bonitos','d) bonitas'],a:3,k:'mc-bonitas'},
  {q:'«Cinco manzanas» lleva un adjetivo…',o:['a) numeral','b) calificativo','c) posesivo','d) demostrativo'],a:0,k:'mc-cinco'},
  {q:'En «el cielo azul», ¿qué palabra es el adjetivo?',o:['a) el','b) cielo','c) azul','d) ninguna'],a:2,k:'mc-azul'},
  {q:'En «ese carro rojo», ¿cuántos adjetivos hay?',o:['a) 1','b) 2','c) 3','d) 0'],a:1,k:'mc-cuantos'},
  {q:'En «la sopa caliente», «caliente» dice…',o:['a) cómo es la sopa','b) cuánta sopa hay','c) de quién es la sopa','d) dónde está la sopa'],a:0,k:'mc-caliente'}
];
const evalCPBank=[
  {q:'La forma más intensa de «alto» es ___.',a:'altísimo',acc:['altísimo'],k:'cp-altisimo'},
  {q:'En «la ventana abierta», el adjetivo es ___.',a:'abierta',acc:['abierta'],k:'cp-abierta'},
  {q:'«Las flores» + «amarillo» → las flores ___.',a:'amarillas',acc:['amarillas'],k:'cp-amarillas'},
  {q:'«Los niños» + «contento» → los niños ___.',a:'contentos',acc:['contentos'],k:'cp-contentos'},
  {q:'En «mi abuela cariñosa», el adjetivo que dice cómo es la abuela es ___.',a:'cariñosa',acc:['cariñosa'],k:'cp-carinosa'},
  {q:'«Las camisas» + «blanco» → las camisas ___.',a:'blancas',acc:['blancas'],k:'cp-blancas'},
  {q:'«El agua» + «frío» → el agua ___.',a:'fría',acc:['fría'],k:'cp-fria'},
  {q:'«Los perros» + «feliz» → los perros ___.',a:'felices',acc:['felices'],k:'cp-felices'},
  {q:'En «dos libros viejos», el adjetivo que dice cuántos es ___.',a:'dos',acc:['dos'],k:'cp-dos'},
  {q:'En «este pueblo tranquilo», el adjetivo que dice cómo es el pueblo es ___.',a:'tranquilo',acc:['tranquilo'],k:'cp-tranquilo'}
];
const evalPRBank=[
  {term:'Grado positivo',def:'La cualidad tal cual, sin comparar',k:'pr-positivo'},
  {term:'Grado comparativo',def:'Compara la cualidad entre dos',k:'pr-comparativo'},
  {term:'Grado superlativo',def:'La cualidad en su punto más alto',k:'pr-superlativo'},
  {term:'Igualdad',def:'tan … como',k:'pr-igualdad'},
  {term:'Superioridad',def:'más … que',k:'pr-superioridad'},
  {term:'Inferioridad',def:'menos … que',k:'pr-inferioridad'},
  {term:'Concordancia',def:'Que el adjetivo vaya igual que su nombre: femenino con femenino, plural con plural',k:'pr-concordancia'},
  {term:'Epíteto',def:'Dice lo que ya se sabe de la cosa: la blanca nieve',k:'pr-epiteto'},
  {term:'Determinativo',def:'Acompaña al nombre sin decir cómo es',k:'pr-determinativo'},
  {term:'Sustantivo',def:'La palabra que el adjetivo acompaña',k:'pr-sustantivo'}
];
