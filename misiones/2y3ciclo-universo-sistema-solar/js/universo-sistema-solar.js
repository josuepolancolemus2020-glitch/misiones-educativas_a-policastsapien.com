...
const qzData=[
  ...
  {q:'¿Qué es un planeta?',o:['a) Un astro que gira alrededor de una estrella','b) Un astro con luz propia','c) Una galaxia','d) Un cometa'],c:0},
  {q:'¿Cuál es el satélite natural de la Tierra?',o:['a) El Sol','b) Marte','c) Venus','d) La Luna'],c:3},
  ...
  {q:'¿Qué movimiento de la Tierra produce el día y la noche?',o:['a) La rotación','b) La traslación','c) El eclipse','d) La fase lunar'],c:0},
  {q:'¿Qué movimiento de la Tierra dura un año?',o:['a) La rotación','b) La traslación','c) La fase lunar','d) El eclipse'],c:1},
  {q:'¿Cómo se llama nuestra galaxia?',o:['a) El Sistema Solar','b) La Osa Mayor','c) Andrómeda','d) La Vía Láctea'],c:3},
];
...
// ===================== COMPLETA =====================
const cmpData=[
  {s:'El ___ es la estrella del sistema solar.',opts:['planeta','satélite','Sol'],c:2},
  {s:'La ___ es el satélite de la Tierra.',opts:['estrella','Luna','galaxia'],c:1},
  {s:'La ___ produce el día y la noche.',opts:['traslación','órbita','rotación'],c:2},
  {s:'La ___ produce las estaciones del año.',opts:['traslación','rotación','fase'],c:0},
  {s:'El sistema solar tiene ___ planetas.',opts:['seis','ocho','siete'],c:1},
  {s:'Las ___ tienen luz propia.',opts:['planetas','estrellas','lunas'],c:1},
  {s:'Nuestra galaxia es la ___.',opts:['Vía Láctea','Osa Mayor','Andrómeda'],c:0},
  {s:'La Luna no tiene luz propia: ___ la del Sol.',opts:['refleja','produce','apaga'],c:0},
];
...
const evalTFBank=[
  ...
  {q:'La Tierra es el único planeta donde sabemos que hay vida.',a:true,k:'tf-vida'},
  {q:'Cuando en un lado de la Tierra es de día, en el otro lado es de noche.',a:true,k:'tf-dia-noche'},
  {q:'En luna nueva, la Luna no se ve.',a:true,k:'tf-luna-nueva'},
  {q:'Muchas estrellas que vemos como puntitos son más grandes que el Sol.',a:true,k:'tf-puntitos'},
...
const evalMCBank=[
  ...
  {q:'Además de los planetas, ¿qué otros cuerpos giran alrededor del Sol?',o:['a) nubes','b) asteroides y cometas','c) montañas','d) océanos'],a:1,k:'mc-asteroides'},
  {q:'¿Qué es el Sol?',o:['a) un planeta','b) una estrella','c) un satélite','d) una galaxia'],a:1,k:'mc-sol'}
];
const evalCPBank=[
  {q:'El planeta más cercano al Sol es ___.',a:'Mercurio',acc:['Mercurio'],k:'cp-mercurio'},
  {q:'La Tierra es el ___ planeta desde el Sol.',a:'tercer',acc:['tercer','tercero','3'],k:'cp-tercer'},
  {q:'La Luna no brilla sola: ___ la luz del Sol.',a:'refleja',acc:['refleja'],k:'cp-refleja'},
  {q:'La mitad de la Luna que se ve después de la luna nueva es el cuarto ___.',a:'creciente',acc:['creciente'],k:'cp-creciente'},
  {q:'Las estrellas son enormes esferas de ___ muy caliente.',a:'gas',acc:['gas'],k:'cp-gas'},
  {q:'La Tierra tiene agua y ___: por eso hay vida.',a:'aire',acc:['aire'],k:'cp-aire'},
  {q:'La Tierra da una vuelta completa sobre sí misma en ___ horas.',a:'24',acc:['24','veinticuatro'],k:'cp-24'},
  {q:'El Sol es una estrella de tamaño ___.',a:'mediano',acc:['mediano','mediana'],k:'cp-mediano'},
  {q:'Un año en la Tierra tiene ___ días.',a:'365',acc:['365'],k:'cp-365'},
  {q:'La otra mitad de la Luna, la que se ve antes de la luna nueva, es el cuarto ___.',a:'menguante',acc:['menguante'],k:'cp-menguante'}
];
const evalPRBank=[
  {term:'Estrella',def:'Tiene luz propia',k:'pr-estrella'},
  {term:'Planeta',def:'Da vueltas a una estrella y no tiene luz propia',k:'pr-planeta'},
  {term:'Satélite',def:'Acompaña a un planeta, como la Luna a la Tierra',k:'pr-satelite'},
  {term:'Galaxia',def:'Un enorme grupo de estrellas',k:'pr-galaxia'},
  {term:'Vía Láctea',def:'La galaxia donde vivimos',k:'pr-via-lactea'},
  {term:'Cometa',def:'Hielo y polvo con una cola',k:'pr-cometa'},
  {term:'Rotación',def:'La Tierra gira sobre sí misma',k:'pr-rotacion'},
  {term:'Traslación',def:'La Tierra gira alrededor del Sol',k:'pr-traslacion'},
  {term:'Eclipse',def:'Un astro tapa la luz de otro',k:'pr-eclipse'},
  {term:'Universo',def:'Todo lo que existe',k:'pr-universo'}
];
...
const critCaseBank=[
  {k:'ca-estrellas-dia',txt:'De día no vemos las estrellas, pero de noche el cielo se llena de ellas.',
  ...
  {k:'ca-dia-noche',txt:'En un lugar de la Tierra es de día mientras que en otro, al mismo tiempo, es de noche.',
  ...
  {k:'ca-sol-se-mueve',txt:'Un niño cree que el Sol se mueve alrededor de la Tierra porque lo ve salir y ponerse.',
  ...
  {k:'ca-puntito',txt:'Miramos una estrella muy lejana y la vemos como un puntito, aunque es gigante.',
...
const critErrorBank=[
  {k:'er-planetas-luz',txt:'"Los planetas tienen luz propia igual que las estrellas."',
  ...
  {k:'er-sol-planeta',txt:'"El Sol es un planeta, igual que la Tierra."',
   g1:'El Sol es una ESTRELLA, no un planeta.',
   g2:'La Tierra es un planeta que gira alrededor de él.'},
];
...
const critCompareBank=[
  {k:'co-eclipses',a:'La Luna se coloca entre el Sol y la Tierra y tapa la luz del Sol.',b:'La Tierra se coloca entre el Sol y la Luna y le tapa la luz.',
  ...
  {k:'co-rocoso-gaseoso',a:'Planeta pequeño y sólido, como la Tierra o Marte.',b:'Planeta enorme formado sobre todo por gas, como Júpiter o Saturno.',
  ...
  {k:'co-sistema-galaxia',a:'El Sol y todos los astros que giran a su alrededor.',b:'Enorme grupo de millones de estrellas.',
   ga:'El sistema solar.',
...
const critCauseBank=[
  {k:'cau-sol-vida',cause:'El Sol da luz y calor a la Tierra.',guide:'Las plantas, los animales y las personas pueden vivir.'},
  {k:'cau-lejanos',cause:'Urano y Neptuno están muy lejos del Sol.',guide:'Son los planetas más fríos.'},
  {k:'cau-mercurio',cause:'Mercurio está pegado al Sol, más que ningún otro planeta.',guide:'Recibe muchísimo calor.'},
  {k:'cau-sol-enorme',cause:'El Sol es muchísimo más grande que la Tierra.',guide:'Dentro de él cabrían más de un millón de Tierras.'},
];
const critEffectBank=[
  {k:'ef-sol-moneda',effect:'Desde la Tierra, el Sol se ve del tamaño de una moneda, aunque es enorme.',guide:'Está muy lejos de nosotros.'},
  {k:'ef-luna-brilla',effect:'La Luna brilla de noche aunque no produce luz.',guide:'Refleja la luz que le llega del Sol.'},
  {k:'ef-vida-tierra',effect:'La Tierra es el único planeta donde sabemos que hay vida.',guide:'Tiene agua y aire.'},
];
