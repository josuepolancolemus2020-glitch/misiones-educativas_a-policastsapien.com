...
const qzData=[
  ...
  {q:'¿Qué es la apotema de un polígono regular?',
   o:['a) Distancia del centro al punto medio del lado','b) El lado más largo','c) La distancia de vértice a vértice','d) La suma de todos los lados'],c:0,
  ...
  {q:'Si el radio de un círculo es 3 cm y consideramos π ≈ 3, su área aproximada es:',
   o:['a) 9 cm²','b) 27 cm²','c) 18 cm²','d) 12 cm²'],c:1,
  ...
  {q:'¿Cómo se calcula el perímetro de un pentágono regular si conoces la medida de un lado (l)?',
   o:['a) P = l + 5','b) P = l²','c) P = 5 · l','d) P = (l · 5) / 2'],c:2,
...
// ===================== COMPLETA =====================
const cmpData=[
  {s:'El área de un círculo es igual a ___ por radio al cuadrado.',opts:['Perímetro','Diámetro','Pi'],c:2},
  {s:'La ___ une el centro del polígono con el punto medio de su lado.',opts:['apotema','diagonal','circunferencia'],c:0},
  {s:'El diámetro equivale exactamente a ___ radios.',opts:['dos','tres','cuatro'],c:0},
