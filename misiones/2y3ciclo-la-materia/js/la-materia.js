...
// ===================== XP =====================
const lvls=[{t:0,n:'Aprendiz 🌱'},{t:25,n:'Explorador 🔬'},{t:55,n:'Naturalista 🧪'},{t:90,n:'Químico ⚗️'},{t:130,n:'Investigador 🔭'},{t:165,n:'Científico 🏅'},{t:190,n:'Científico de la Materia 🏆'}];
...
const evalTFBank=[
  ...
  {q:'El líquido toma la forma del recipiente donde se echa.',a:true,k:'tf-liquido'},
  {q:'El gas ocupa todo el espacio disponible.',a:true,k:'tf-gas'},
  {q:'Una gota de agua tiene millones de millones de partículas.',a:true,k:'tf-gota'},
  {q:'Cuando el agua se congela deja de ser agua.',a:false,k:'tf-congela'},
  {q:'El oro es una mezcla.',a:false,k:'tf-oro'},
  {q:'El aire es una mezcla.',a:true,k:'tf-aire-mezcla'},
  {q:'El agua puede estar en tres estados.',a:true,k:'tf-tres-estados'},
  {q:'Las partículas que forman la materia se ven a simple vista.',a:false,k:'tf-particulas'}
];
const evalMCBank=[
  ...
  {q:'¿Qué pasa con la sal al revolverla en agua?',o:['a) Flota','b) Se vuelve arena','c) Se disuelve y no se ve','d) Se pone roja'],a:2,k:'mc-disuelve'},
  {q:'¿En qué estado está el aceite de cocina?',o:['a) Sólido','b) Líquido','c) Gaseoso','d) Ninguno'],a:1,k:'mc-aceite'}
];
const evalCPBank=[
  {q:'La fuerza con que la gravedad atrae a un cuerpo es su ___.',a:'peso',acc:['peso'],k:'cp-peso'},
  {q:'El agua en estado sólido es el ___.',a:'hielo',acc:['hielo'],k:'cp-hielo'},
  {q:'La mezcla en la que se ven sus partes es ___.',a:'heterogénea',acc:['heterogénea','heterogenea'],k:'cp-heterogenea'},
  {q:'Un material que tiene mucha materia en poco espacio es ___.',a:'denso',acc:['denso','densa'],k:'cp-denso'},
  {q:'Las propiedades que tiene toda la materia se llaman ___.',a:'generales',acc:['generales'],k:'cp-generales'},
  {q:'Todo lo que puedes tocar, ver o ___ está hecho de materia.',a:'pesar',acc:['pesar'],k:'cp-pesar'},
  {q:'La paleta helada gotea porque se está ___.',a:'derritiendo',acc:['derritiendo'],k:'cp-derritiendo'},
  {q:'El aire es materia porque pesa y ocupa un ___.',a:'lugar',acc:['lugar'],k:'cp-lugar'},
  {q:'En la costa sacan la sal dejando agua de mar al ___.',a:'sol',acc:['sol'],k:'cp-sol'},
  {q:'Reutilizar y ___ los materiales cuida el planeta.',a:'reciclar',acc:['reciclar'],k:'cp-reciclar'}
];
const evalPRBank=[
  {term:'Masa',def:'Cuánta materia tiene un cuerpo',k:'pr-masa'},
  {term:'Volumen',def:'Cuánto espacio ocupa un cuerpo',k:'pr-volumen'},
  {term:'Fusión',def:'Paso de sólido a líquido',k:'pr-fusion'},
  {term:'Solidificación',def:'Paso de líquido a sólido',k:'pr-solidificacion'},
  {term:'Evaporación',def:'Paso de líquido a gas',k:'pr-evaporacion'},
  {term:'Condensación',def:'Paso de gas a líquido',k:'pr-condensacion'},
  {term:'Átomo',def:'La partícula más pequeña de la materia',k:'pr-atomo'},
  {term:'Molécula',def:'Unión de varias partículas, como el agua',k:'pr-molecula'},
  {term:'Mezcla homogénea',def:'No se distinguen sus partes',k:'pr-homogenea'},
  {term:'Sustancia pura',def:'Tiene un solo tipo de materia',k:'pr-pura'}
];
...
.forma-tag{font-size:7pt;color:#555;border:1px solid #bbb;padding:1px 5px;border-radius:3px;background:white;white-space:nowrap;}@media print{@page{size:letter portrait;margin:5mm 7mm;}body{padding-bottom:9mm;}}</style></head><body><div id="evalPage"><div class="ph"><h2>Evaluación Final · La Materia · Educación Básica · Ciencias Naturales</h2><div class="ph-line"><strong>Nombre:</strong><span class="ph-fill">&nbsp;</span><strong>Parcial:</strong><span class="ph-s">&nbsp;</span><strong>Fecha:</strong><span class="ph-m">&nbsp;</span></div><div class="ph-line"><strong>Instituto:</strong><span class="ph-fill">&nbsp;</span><strong>Grado y Sección:</strong><span class="ph-s">&nbsp;</span><strong>Nº Lista:</strong><span class="ph-xs">&nbsp;</span></div><p class="ph-crit">Valor total: 100 puntos · Cada respuesta vale 5 puntos</p></div>${s1}${s2}${s3}${s4}<div class="total-row"><span>Total, obtenido</span><span class="obt-line"></span><span>de 100%</span></div></div><div class="pauta-wrap" id="pautaPage"><div class="p-head"><div class="p-main">✅ PAUTA — Evaluación Final · La Materia · Forma ${forma}</div><div class="p-sub">Documento exclusivo del docente · No distribuir al estudiante</div><div class="p-meta">Valor total: 100 pts | 4 secciones × 5 preguntas × 5 pts c/u</div></div><div class="p-grid">${pR}</div>
...
const critCaseBank=[
  {k:'ca-hielo',txt:'Dejamos un cubo de hielo sobre la mesa y al rato solo queda un charco de agua.'},
  {k:'ca-olla',txt:'Ponemos agua a hervir y, poco a poco, la olla se va quedando con menos agua.'},
  {k:'ca-vaso',txt:'Un vaso de agua fría "suda" por fuera: aparecen gotitas en la parte de afuera.'},
  {k:'ca-charco',txt:'Después de la lluvia queda un charco en la calle, pero con el sol del mediodía el charco desaparece.'},
  {k:'ca-espejo',txt:'Al bañarnos con agua caliente, el espejo del baño se empaña y se llena de gotitas.'},
  {k:'ca-paleta',txt:'Una paleta helada empieza a gotear si tardamos mucho en comerla.'},
];
...
const critErrorBank=[
  ...
  {k:'er-color',txt:'"El color y el olor son propiedades generales de la materia."',
...
const critDecisionBank=[
  {k:'de-filtro',txt:'Para separar la arena del agua, conviene colarla con un filtro, o dejarla mezclada.',
  ...
  {k:'de-balanza',txt:'Para medir la masa de un objeto, conviene usar una balanza, o calcularlo a ojo.',
...
const critEffectBank=[
  ...
  {k:'ef-clavo',effect:'Un clavo de hierro se hunde y un trozo de madera del mismo tamaño flota.',guide:'El hierro es más denso: tiene más materia en el mismo espacio.'},
  {k:'ef-perfume',effect:'Al abrir un perfume, el olor llega a toda la sala.',guide:'El perfume se vuelve gas, y el gas se reparte por toda la sala.'},
];
...
function genEvalCrit(){
  ...
  document.getElementById('evalcrit-screen-title').textContent=`🧠 Pensamiento Crítico · Forma ${cf} · La Materia`;
...
window.addEventListener('DOMContentLoaded',()=>{
  ...
  showEnfer();
  updateLabDisplay();
  document.querySelector('[data-parte="solido"]')?.classList.add('active-pri');
