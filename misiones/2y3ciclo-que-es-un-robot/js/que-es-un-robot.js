...
let evalCPBank=[
  ...
  {q:'Receptor → cerebro → ___, como en tu cuerpo.',a:'efector',acc:['efector'],k:'cp-efector'}
];
let evalPRBank=[
  {term:'Sensor',def:'Capta luz, sonido o distancia',k:'pr-sensor'},
  {term:'Controlador',def:'Recibe la información y elige qué hacer',k:'pr-controlador'},
  {term:'Actuador',def:'Motor o rueda que ejecuta la acción',k:'pr-actuador'},
  {term:'Batería',def:'El «alimento» del robot',k:'pr-bateria'},
  {term:'Dron',def:'Vuela con hélices sobre el cafetal',k:'pr-dron'},
  {term:'Humanoide',def:'Robot con forma de persona',k:'pr-humanoide'},
  {term:'Máquina simple',def:'No percibe, no decide y la mueves tú',k:'pr-simple'},
  {term:'Electrodoméstico',def:'Actúa al encenderlo, pero no decide',k:'pr-electrodomestico'},
  {term:'Robot industrial',def:'Brazo fijo que trabaja en una fábrica',k:'pr-industrial'},
  {term:'Robótica desconectada',def:'Aprender robótica sin computadora ni cables',k:'pr-desconectada'}
];
...
let critSensorBank=[
  {k:'se-riego',txt:'Un robot riega la huerta escolar solo cuando la tierra está seca.',ans:'Sensor de humedad: mide el agua de la tierra; si está seca, el controlador decide abrir el riego.'},
  {k:'se-distancia',txt:'Un robot mensajero se detiene antes de chocar con una pared o una persona.',ans:'Sensor de distancia: mide qué tan cerca está el obstáculo; si está muy cerca, el controlador decide frenar.'},
  {k:'se-lampara',txt:'Una lámpara robótica se enciende sola cuando llega la noche.',ans:'Sensor de luz: detecta que oscureció; el controlador decide encender la lámpara.'},
  {k:'se-incubadora',txt:'Un robot cuida la incubadora de pollitos y avisa si se enfría.',ans:'Sensor de temperatura: mide el calor; si baja demasiado, el controlador decide encender la alarma o el foco.'},
  {k:'se-aplauso',txt:'Un robot de juguete arranca cuando el niño aplaude dos veces.',ans:'Sensor de sonido: capta los aplausos; el controlador decide poner en marcha los motores.'},
...
let critCompareBank=[
  {k:'co-sensor-actuador',a:'Parte del robot que hace de «sentidos».',b:'Parte del robot que hace de «músculos».',ga:'El sensor.',gb:'El actuador.',gr:'Semejanza: los dos son partes del robot conectadas al controlador. Diferencia: el sensor mete información (percibe) y el actuador saca acción (actúa), como los sentidos y los músculos del cuerpo.'},
  {k:'co-movil-humanoide',a:'Robot que se desplaza con ruedas por la casa o el aula.',b:'Robot con forma de persona, que camina y mueve los brazos.',ga:'El robot móvil.',gb:'El humanoide.',gr:'Semejanza: los dos perciben, deciden y actúan. Diferencia: uno se mueve con ruedas y el otro tiene cuerpo con forma de persona.'},
];
let critDesignBank=[
