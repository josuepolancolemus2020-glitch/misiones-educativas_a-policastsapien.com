...
(function () {
  ...
  window.MISION_EN = {
    ...
    data: {
      ...
      evalPRBank: [
        { term: 'Maybe', def: 'An answer a condition cannot have' },
        { term: 'Sensor', def: 'The robot’s «questions»' },
        { term: 'Chained', def: 'Several questions in a row' },
        { term: 'Action', def: 'An order that moves the robot' },
        { term: 'WAIT', def: 'An instruction for not crossing on red' },
        { term: 'Traffic light', def: 'A street light that says go or not' },
        { term: 'Wood stove', def: 'IF it is lit, you cook' },
        { term: 'Sweater', def: 'What you wear IF it is cold' },
        { term: 'Tree', def: 'It works as a wall in the simulator' },
        { term: 'Swapping the branches', def: 'Putting the «yes» where the «no» went' }
      ],
