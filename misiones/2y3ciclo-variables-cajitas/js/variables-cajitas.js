...
const evalMCBank=[
  {q:'Una variable en programación es como…',o:['Una cajita con nombre que guarda un valor que puede cambiar','Un dibujo del robot','Un error del programa','Un botón de apagado'],a:0},
  {q:'¿Qué hace GUARDA 5 EN puntos si puntos ya tenía 8?',o:['Deja 13','Deja 8','Da error','Deja 5 y borra el 8'],a:3},
  {q:'¿Qué instrucción mira el valor sin cambiarlo?',o:['GUARDA','MUESTRA','SUMA','RESTA'],a:1},
  {q:'Ejecuta: GUARDA 4 EN goles · SUMA 1 A goles · SUMA 1 A goles. ¿Cuánto vale goles?',o:['4','5','6','7'],a:2},
  {q:'¿Cuál es un buen nombre de variable para el dinero de la alcancía?',o:['dinero','x7','GUARDA','MUESTRA'],a:0},
  {q:'El contador…',o:['suma cantidades distintas','sube de 1 en 1','borra la cajita','nunca cambia'],a:1},
  {q:'El acumulador…',o:['suma cantidades distintas cada vez','sube siempre de 1 en 1','solo lee el valor','apaga el programa'],a:0},
  {q:'Ejecuta: GUARDA 10 EN dinero · RESTA 4 A dinero. ¿Cuánto queda?',o:['14','10','6','4'],a:2},
  {q:'GUARDA 6 EN puntos · ___ deja puntos en 9. ¿Qué instrucción falta?',o:['RESTA 3 A puntos','GUARDA 15 EN puntos','MUESTRA puntos','SUMA 3 A puntos'],a:3},
  {q:'La asistencia del aula que sube de 1 en 1 es un…',o:['acumulador','bug','contador','nombre'],a:2},
  {q:'La venta de la pulpería (L 12 + L 8 + L 5) es un…',o:['acumulador','contador','giro','dibujo'],a:0},
  {q:'¿Cuántos valores guarda una variable a la vez?',o:['Dos','Uno','Diez','Todos los que quiera'],a:1},
  {q:'Ejecuta: GUARDA 7 EN puntos · MUESTRA puntos. ¿Cuánto vale puntos al final?',o:['0','14','7','Nada'],a:2},
  {q:'¿Qué hace RESTA 2 A vidas?',o:['Aumenta 2 al valor','Quita 2 usando el valor actual','Borra la variable','Muestra el valor'],a:1},
  {q:'Al trazar la tabla de valores escribimos…',o:['el nombre del alumno','solo el resultado final sin pasos','un dibujo de la cajita','el valor de la cajita después de cada instrucción'],a:3},
];
const evalCPBank=[
