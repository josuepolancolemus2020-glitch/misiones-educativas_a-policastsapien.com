...
const evalTFBank=[
  ...
  {q:'La máquina decide sola cuándo sumar.',a:false,k:'tf-decide'},
...
const evalCPBank=[
  ...
  {q:'Ejecuta: GUARDA 8 EN puntos · GUARDA 3 EN puntos. Al final puntos vale ___.',a:'3',acc:['3','tres'],k:'cp-3'},
  {q:'Después de ver su valor sin tocarlo, la cajita queda ___.',a:'igual',acc:['igual'],k:'cp-igual'},
  {q:'Las instrucciones se ejecutan en ___, una por una.',a:'orden',acc:['orden'],k:'cp-orden'},
  {q:'GUARDA 4 EN vidas · RESTA 1 A vidas: quedan ___ vidas.',a:'3',acc:['3','tres'],k:'cp-vidas'},
  {q:'El escenario ☕ de la Máquina de Cajitas es la ___.',a:'cosecha',acc:['cosecha'],k:'cp-cosecha'},
  {q:'La máquina solo ___ las instrucciones.',a:'obedece',acc:['obedece','cumple'],k:'cp-obedece'}
];
const evalPRBank=[
  {term:'Variable',def:'Cajita con nombre que guarda un valor',k:'pr-variable'},
  {term:'Contador',def:'Sube de 1 en 1',k:'pr-contador'},
  {term:'Acumulador',def:'Suma cantidades distintas cada vez',k:'pr-acumulador'},
  {term:'Trazar',def:'Seguir la cajita paso a paso para predecir',k:'pr-trazar'},
  {term:'Valor inicial',def:'Con qué número arranca la cajita',k:'pr-inicial'},
