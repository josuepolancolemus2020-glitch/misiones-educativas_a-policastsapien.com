...
const identifyTaskDB=[
  {s:'Lempira dirigió la resistencia lenca contra la conquista.',target:'Lempira'},
  {s:'José Cecilio del Valle redactó el Acta de Independencia.',target:'Acta'},
  {s:'Francisco Morazán presidió la República Federal.',target:'Federal'},
  {s:'Dionisio de Herrera gobernó Honduras desde 1824.',target:'1824'},
  {s:'A Cabañas le decían el caballero sin tacha y sin miedo.',target:'tacha'},
  {s:'José Trinidad Reyes fundó la primera universidad.',target:'universidad'},
  {s:'Ramón Rosa impulsó el Código de Instrucción Pública.',target:'Código'},
  {s:'Marco Aurelio Soto encabezó la Reforma Liberal.',target:'Reforma'},
  {s:'Lempira resistió desde el Peñol de Cerquín.',target:'Cerquín'},
  {s:'El Día del Maestro Hondureño es el 17 de septiembre.',target:'Maestro'}
];
