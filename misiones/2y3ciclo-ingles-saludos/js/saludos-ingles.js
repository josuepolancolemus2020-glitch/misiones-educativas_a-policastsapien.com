...
let evalTFBank=[
  {q:'En inglés hay dos maneras de decir la noche: una al llegar y otra al irse.',a:true,k:'tf-noches'},
  {q:'«Hi» es un saludo informal.',a:true,k:'tf-hi'},
  {q:'«Hello» sirve con cualquier persona.',a:true,k:'tf-hello'},
  {q:'«Bye» sirve para saludar al llegar.',a:false,k:'tf-bye'},
  {q:'A la directora de la escuela se le saluda con «Hey!».',a:false,k:'tf-hey'},
  {q:'«How are you?» pregunta el nombre de la persona.',a:false,k:'tf-how'},
  {q:'«See you later» se usa al llegar a un lugar.',a:false,k:'tf-later'},
  {q:'Con un compañero de clase se puede saludar de manera informal.',a:true,k:'tf-companero'},
  {q:'«Thank you» y «Thanks» sirven para agradecer.',a:true,k:'tf-thanks'},
  {q:'«Good afternoon» se usa en la tarde.',a:true,k:'tf-afternoon'}
];
let evalMCBank=[
  {q:'Son las 9 de la mañana. ¿Cómo saludas a tu maestra?',o:['a) Hey','b) Good morning','c) Bye','d) See you later'],a:1,k:'mc-morning'},
  {q:'Llegas a las 8 de la noche a una reunión. ¿Cómo saludas?',o:['a) Hi','b) Bye','c) Good evening','d) See you later'],a:2,k:'mc-evening'},
  {q:'¿Cómo le preguntas su nombre a alguien?',o:['a) How old are you?','b) Hey','c) Thanks','d) What’s your name?'],a:3,k:'mc-name'},
  {q:'Te preguntan «How are you?». ¿Qué respondes?',o:['a) Fine, thank you.','b) See you later','c) Hello','d) Hi'],a:0,k:'mc-fine'},
  {q:'Te dicen «Thank you». ¿Qué respondes?',o:['a) Hello','b) You’re welcome','c) Bye','d) Hey'],a:1,k:'mc-welcome'},
  {q:'Te despides de tu maestra hasta el otro día. ¿Qué dices?',o:['a) Hi','b) Hello','c) See you tomorrow','d) Hey'],a:2,k:'mc-tomorrow'},
  {q:'¿Qué dices para despedirte de la directora?',o:['a) Bye','b) See you later','c) Hey','d) Goodbye'],a:3,k:'mc-goodbye'},
  {q:'Te despides de tu mamá antes de irte a dormir. ¿Qué dices?',o:['a) Good night','b) Hello','c) Hi','d) Thanks'],a:0,k:'mc-night'},
  {q:'¿Cómo suena la h de «hello», «hi» y «how»?',o:['a) Es muda','b) Como una j suave','c) Como una s','d) Como una g'],a:1,k:'mc-h'},
  {q:'Un turista te dice «Nice to meet you». ¿Qué le contestas?',o:['a) Bye','b) Hey','c) Nice to meet you, too','d) Thanks'],a:2,k:'mc-too'}
];
let evalCPBank=[
  {q:'En «thank you», la th va con la lengua entre los ___.',a:'dientes',acc:['dientes'],k:'cp-th'},
  {q:'«Good afternoon» empieza a las 12 y termina a las ___ de la tarde.',a:'6',acc:['6','seis'],k:'cp-seis'},
  {q:'«I’m» es la forma corta de «I ___».',a:'am',acc:['am'],k:'cp-am'},
  {q:'«Hey» es un saludo para los ___ y compañeros.',a:'amigos',acc:['amigos'],k:'cp-amigos'},
  {q:'Para pedir algo con cortesía se agrega ___.',a:'please',acc:['please'],k:'cp-please'},
  {q:'A «How old are you?» se contesta con tu ___.',a:'edad',acc:['edad'],k:'cp-edad'},
  {q:'Con la directora se usa el registro ___.',a:'formal',acc:['formal'],k:'cp-formal'},
  {q:'Sin el soplo de la h, «hi» suena como «eye», que quiere decir ___.',a:'ojo',acc:['ojo'],k:'cp-eye'},
  {q:'«Good morning» se usa desde que amanece hasta las ___ del mediodía.',a:'12',acc:['12','doce'],k:'cp-doce'},
  {q:'En inglés se saluda distinto según la ___ del día.',a:'hora',acc:['hora'],k:'cp-hora'}
];
let evalPRBank=[
  {term:'Hola',def:'Hello',k:'pr-hola'},
  {term:'Chao',def:'Bye',k:'pr-chao'},
  {term:'Hasta luego',def:'See you later',k:'pr-luego'},
  {term:'Gracias',def:'Thanks',k:'pr-gracias'},
  {term:'Buenas tardes',def:'Good afternoon',k:'pr-tardes'},
  {term:'¿Cómo estás?',def:'How are you?',k:'pr-estas'},
  {term:'¿Cuántos años tienes?',def:'How old are you?',k:'pr-anios'},
  {term:'¿Y tú?',def:'And you?',k:'pr-ytu'},
  {term:'Oye (muy informal)',def:'Hey',k:'pr-oye'},
  {term:'Me llamo',def:'My name is',k:'pr-llamo'}
];
...
let critSensorBank=[
  {k:'se-manana',txt:'Son las 7:00 de la mañana y entras al aula donde está tu maestra.',ans:'Good morning, teacher. Es antes de las 12 y con una persona de respeto: saludo formal de la mañana.'},
  {k:'se-reunion',txt:'Llegas a las 8:00 de la noche a una reunión en casa de un vecino.',ans:'Good evening. Es un saludo (estás llegando) y ya pasaron las 6 de la tarde. «Good night» sería un error: eso es despedida.'},
  {k:'se-dormir',txt:'Te despides de tu mamá antes de irte a dormir.',ans:'Good night. Aquí sí corresponde, porque es una despedida y vas a dormir.'},
  {k:'se-turista',txt:'Un turista llega a las 2:00 de la tarde a tu comunidad y quieres presentarte.',ans:'Good afternoon. My name is… / I’m… Nice to meet you. Saludo de la tarde + presentación + cortesía.'},
  {k:'se-amigo',txt:'Tu mejor amigo entra al aula y lo saludas rápido.',ans:'Hi! o Hello! Es informal y con un compañero: no hace falta el saludo formal.'},
  {k:'se-clase',txt:'Terminó la clase y verás a tu maestra hasta el día siguiente.',ans:'Goodbye. See you tomorrow. Despedida formal + hasta mañana.'},
];
let critErrorBank=[
  {k:'er-night',txt:'"Llegué a la reunión de noche y saludé diciendo: Good night."',g1:'Good night NO es un saludo: es una DESPEDIDA, se dice al irse o al ir a dormir.',g2:'Al LLEGAR de noche se dice Good evening. Misma hora, distinto momento de la conversación.'},
  {k:'er-h',txt:'"Dije hello pronunciando «elou», sin la h."',g1:'En inglés la h de hello, hi y how SÍ suena: es un soplo, como una j suave.',g2:'Sin ese soplo cambian las palabras: hi suena como eye («ojo»). La pronunciación es parte del significado.'},
];
...
let critCicloBank=[
  {k:'ci-ana',txt:'Ana llega al aula a las 7:15 de la mañana. Saluda a su maestra, se presenta con un compañero nuevo y al terminar la clase se despide de los dos.',p:'Con la maestra: Good morning, teacher (antes de las 12 y con respeto). Con el compañero basta Hi o Hello.',d:'Con el compañero: Hi! I’m Ana. What’s your name? — y responde Nice to meet you al escuchar el nombre.',a:'Con la maestra: Goodbye, teacher. Con el compañero: Bye! See you tomorrow!'},
  {k:'ci-luis',txt:'Don Luis llega a las 6:30 de la tarde a una reunión de padres, saluda a la directora que no conocía y se retira cuando ya es de noche.',p:'Good evening: ya pasaron las 6 de la tarde y está LLEGANDO, así que no corresponde Good night.',d:'Good evening. My name is Luis Pérez. Nice to meet you. Presentación formal con nombre completo.',a:'Al irse: Good night o Goodbye. Aquí sí cabe Good night, porque se está despidiendo de noche.'},
  {k:'ci-maria',txt:'Dos turistas llegan a las 11:00 de la mañana a la pulpería de María y le preguntan su nombre.',p:'Good morning: son las 11, todavía es antes del mediodía.',d:'María responde: Good morning! My name is María. Nice to meet you.',a:'Al salir los turistas: Goodbye! Thank you! y María responde You’re welcome. Bye!'},
  {k:'ci-carlos',txt:'Carlos se encuentra a su mejor amigo en la cancha a las 4 de la tarde y quedan de verse al día siguiente.',p:'Con un amigo y a esa hora: Hi! o Hey! (informal). También sirve Good afternoon, pero suena muy formal entre amigos.',d:'No hace falta presentarse: ya se conocen. Basta How are you? y la respuesta I’m fine, thanks.',a:'See you tomorrow! o Bye! — despedida informal.'},
  {k:'ci-sofia',txt:'Una alumna nueva llega al aula a media mañana; la maestra la presenta al grupo y al final del día se despide de todos.',p:'Good morning, everyone: sigue siendo antes del mediodía y saluda a todo el grupo.',d:'Hello! My name is Sofía. Nice to meet you. El grupo responde Nice to meet you, too.',a:'Goodbye, everyone! See you tomorrow!'},
];
let critCompareBank=[
  {k:'cm-registro',a:'Saludo que se usa con la directora, un maestro o un visitante.',b:'Saludo que se usa con un compañero de clase o un amigo.',ga:'Formal (Good morning / Good afternoon).',gb:'Informal (Hi / Hey).',gr:'Semejanza: las dos son maneras correctas de saludar. Diferencia: el REGISTRO. Usar el informal con una autoridad suena irrespetuoso; usar el formal con un amigo suena distante.'},
  {k:'cm-nombre',a:'Pregunta por el nombre de la persona.',b:'Pregunta por el estado de la persona.',ga:'What’s your name?',gb:'How are you?',gr:'Semejanza: las dos son preguntas de una presentación. Diferencia: la primera se responde con My name is… y la segunda con I’m fine, thank you.'},
  {k:'cm-gracias',a:'Expresión de agradecimiento.',b:'Respuesta a un agradecimiento.',ga:'Thank you.',gb:'You’re welcome.',gr:'Semejanza: las dos son cortesía y van juntas en la misma conversación. Diferencia: una la dice quien recibe el favor y la otra quien lo hizo.'},
];
let critDesignBank=[
